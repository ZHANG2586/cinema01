      ...
      if(props.location.state !== undefined){
        ...
        if(props.location.state !== undefined){
          props.history.push({pathname:'/ticket-center',state:{username:props.location.state.username,
            ...
            identification:props.location.state.identification,
            moviename:'绣春刀',
            url2:'https://dss1.baidu.com/6ONXsjip0QIZ8tyhnq/it/u=1486586530,1896883687&fm=58&s=1FF66C845822BEDC5C81B507030000C1',
            director:'真岛浩'}});
          }else{
            alert('你还未登录！请先登录！');
            props.history.push('/');
        ...
        <Layout>
             ...
             <Content style={{width:'100%',height:'1800px'}}>
                  <Bread4 state={{username :props.location.state === undefined ? '' : props.location.state.username,
                             ...
                             breadcrumbName2={{path: '/ticket-center',breadcrumbName: '武侠片>'}}/>
                  ...
                  <div style={{position:'relative',left:'64.25px',overflow:'hidden',height:'300px',width:'1391px'}}>                
                      <div style={{display:'inline-block',height:'300px',width:'46%',marginRight:'5px'}}>
                            <ul style={{position:'relative',height:'100%'}}>
                                <li  onClick={push1} ref={li1} style={{cursor: 'pointer',zIndex:'5',position:'absolute',width:'100%',height:'100%'}}><img style={{width:'100%',height:'100%'}} src='https://dss1.baidu.com/6ONXsjip0QIZ8tyhnq/it/u=1486586530,1896883687&fm=58&s=1FF66C845822BEDC5C81B507030000C1'></img></li>
