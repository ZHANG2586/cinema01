      ...
      if(props.location.state !== undefined){
        ...
        if(props.location.state !== undefined){
          props.history.push({pathname:'/ticket-center',state:{username:props.location.state.username,
            ...
            identification:props.location.state.identification,
            moviename:'平然心动',
            url2:'https://dss1.baidu.com/6ONXsjip0QIZ8tyhnq/it/u=997387951,1693282745&fm=58&s=4F530BC3C4421CF6705554090300E0D1',
            director:'真岛浩'}});
          }else{
            alert('你还未登录！请先登录！');
            props.history.push('/');
        ...
        <Layout>
             ...
             <Content style={{width:'100%',height:'1800px'}}>
                <Bread4 state={{username :props.location.state === undefined ? '' : props.location.state.username,
                             ...
                             breadcrumbName2={{path: '/ticket-center',breadcrumbName: '喜剧片>'}}/>
                  ...
                  <div style={{position:'relative',left:'64.25px',overflow:'hidden',height:'300px',width:'1391px'}}>                
                      <div style={{display:'inline-block',height:'300px',width:'46%',marginRight:'5px'}}>
                            <ul style={{position:'relative',height:'100%'}}>
                                <li  onClick={push1} ref={li1} style={{cursor: 'pointer',zIndex:'5',position:'absolute',width:'100%',height:'100%'}}><img style={{width:'100%',height:'100%'}} src='https://dss1.baidu.com/6ONXsjip0QIZ8tyhnq/it/u=997387951,1693282745&fm=58&s=4F530BC3C4421CF6705554090300E0D1'></img></li>
                                <li onClick={push2} ref={li2} style={{cursor:'pointer',zIndex:'4',position:'absolute',width:'100%',height:'100%'}}><img style={{width:'100%',height:'100%'}} src='https://dss0.baidu.com/6ONWsjip0QIZ8tyhnq/it/u=1571859129,1759002486&fm=58&s=F7819B095083FAFA16A418CE0300A090'></img></li>
