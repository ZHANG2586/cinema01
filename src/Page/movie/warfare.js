      ...
      const push1=(e)=>{
        ...
        if(props.location.state !== undefined){
          props.history.push({pathname:'/ticket-center',state:{username:props.location.state.username,
            ...
            identification:props.location.state.identification,
            moviename:'真三国英雄',
            url2:'https://dss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=537901376,2819539695&fm=58&app=83&f=JPEG?w=400&h=533',
            director:'真岛浩'}});
          }else{
            alert('你还未登录！请先登录！');
            props.history.push('/');
        ...
        if(props.location.state !== undefined){
            props.history.push({pathname:'/ticket-center',state:{username:props.location.state.username,
              ...
              identification:props.location.state.identification,
              moviename:'永恒的紫罗兰',
              url2:'https://dss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=1132736462,3694389185&fm=58&app=83&f=JPEG?w=400&h=533',
              director:'真岛浩'}});
         }else{
             alert('你还未登录！请先登录！');
             props.history.push('/');
        ...
        <Layout>
             ...
             <Content style={{width:'100%',height:'1800px'}}>
                  <Bread4 state={{username :props.location.state === undefined ? '' : props.location.state.username,
                             ...
                             breadcrumbName2={{path: '/ticket-center',breadcrumbName: '战争片>'}}/>
                  ...
                  <div style={{position:'relative',left:'64.25px',overflow:'hidden',height:'300px',width:'1391px'}}>                
                      <div style={{display:'inline-block',height:'300px',width:'46%',marginRight:'5px'}}>
                            <ul style={{position:'relative',height:'100%'}}>
                                <li  onClick={push1} ref={li1} style={{cursor: 'pointer',zIndex:'5',position:'absolute',width:'100%',height:'100%'}}><img style={{width:'100%',height:'100%'}} src='https://dss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=537901376,2819539695&fm=58&app=83&f=JPEG?w=400&h=533'></img></li>
                                <li onClick={push2} ref={li2} style={{cursor:'pointer',zIndex:'4',position:'absolute',width:'100%',height:'100%'}}><img style={{width:'100%',height:'100%'}} src='https://dss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=1132736462,3694389185&fm=58&app=83&f=JPEG?w=400&h=533'></img></li>
